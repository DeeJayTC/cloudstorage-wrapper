    ...
    public class ProxyController : Controller
    {
        ...
        public async Task<IActionResult> Get(string url)
        {
            try
            {
                ...
                using (var client = CreateClient(Request.Headers, validatedRequest.Domain))
                {
        ...
        private HttpClient CreateClient(IHeaderDictionary headers, Uri baseUrl)
        {
            ...
            client.DefaultRequestHeaders.UserAgent.ParseAdd(Request.Headers["User-Agent"].ToString());
        ...
        private ProxyRequest ValidateRequest(HttpRequest req)
        {
            try
            {
                ...
                var forDomain = Request.Headers["x-requested-for"];
